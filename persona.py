"""
페르소나 (4축 분석 + 중복 방지 + 닉네임 기반 SET).

축: 데이터 / 콘텐츠 / AI Commerce / UX
응답 구조:
- stance, target
...
ALL_DIMENSIONS = ["데이터", "콘텐츠", "AI Commerce", "UX"]
...
🛍️ AI Commerce
  - ChatGPT/Perplexity/Gemini가 상품을 추천할 때 우리 데이터를 인용·추천하게 만드는 측면
  - Google Shopping/Merchant Center 친화성, Product/Offer/Review/AggregateRating 스키마
...
[핵심 원칙 — 어기면 발언이 폐기됩니다]
1. 한국어로 응답.
2. 4개 축(데이터/콘텐츠/AI Commerce/UX) 중 **1~2개를 선택**해서 발언. 한 발언에 모든 축 다루지 않음.
...

{
  ...
  "dimensions": [
    {
      "axis": "데이터|콘텐츠|AI Commerce|UX 중 하나",
      "evidence": [
...
DEFAULT_PERSONAS = [
    ...
    # ---- 마케팅/브랜드 적합도 (1명) ----
    {
        ...
        "focus_dimensions": ["콘텐츠", "AI Commerce"],
        "color": "#00C7BE",
        "emoji": "🎯",
    },
    ...
    # ---- AI Commerce 축 (2명) ----
    {
        ...
        "description": "ChatGPT/Perplexity/Gemini가 어떤 제품을 추천하는지 매일 추적하는 전략가. 'AI 답변 한 줄 안에 들어가느냐'가 전부.",
        "personality": "실용적이고 빠름. 'Product 스키마에 aggregateRating 없으면 후보 탈락이야' 같은 톤. 결론부터.",
        "expertise": "Google Merchant Center, Product/Offer/Review/AggregateRating 스키마, AI Shopping(ChatGPT Shopping) 노출 메커니즘, 제품 데이터 피드",
